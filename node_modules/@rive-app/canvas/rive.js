...
}, 488527:() => void 0 !== navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia, 488631:() => {
  try {
...
}, 491679:a => window.h.qa(a).L.sampleRate, 491752:a => {
  a = window.h.qa(a);
